...
`git clone https://github.com/seu-usuario/cybersecurity_roadmap.git`

Agora você já pode começar a contribuir com o projeto!

## Reportando Issues

Você pode criar uma issue [aqui](https://github.com/marianabsctba/cybersecurity_roadmap/issues), mas, lembre-se de ser claro e informar o máximo de detalhes possíveis.
